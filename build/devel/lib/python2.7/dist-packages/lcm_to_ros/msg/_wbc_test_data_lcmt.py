...
"""autogenerated by genpy from lcm_to_ros/wbc_test_data_lcmt.msg. Do not edit."""
import codecs
import sys
...
class wbc_test_data_lcmt(genpy.Message):
  _md5sum = "8ec9ea25f44f35a3fb8309b3fd66e8e3"
  _type = "lcm_to_ros/wbc_test_data_lcmt"
...
int64               timestamp_us
"""
  __slots__ = ['contact_est','Fr_des','Fr','body_ori_cmd','body_pos_cmd','body_vel_cmd','body_ang_vel_cmd','body_rpy_cmd','body_pos','body_vel','body_ori','body_ang_vel','body_rpy','foot_pos_cmd','foot_vel_cmd','foot_acc_cmd','foot_acc_numeric','foot_pos','foot_vel','foot_local_pos','foot_local_vel','jpos_cmd','jvel_cmd','jacc_cmd','jpos','jvel','vision_loc','timestamp_us']
  _slot_types = ['int32[4]','float32[12]','float32[12]','float32[4]','float32[3]','float32[3]','float32[3]','float32[3]','float32[3]','float32[3]','float32[4]','float32[3]','float32[3]','float32[12]','float32[12]','float32[12]','float32[12]','float32[12]','float32[12]','float32[12]','float32[12]','float32[16]','float32[16]','float32[16]','float32[16]','float32[16]','float32[3]','int64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       contact_est,Fr_des,Fr,body_ori_cmd,body_pos_cmd,body_vel_cmd,body_ang_vel_cmd,body_rpy_cmd,body_pos,body_vel,body_ori,body_ang_vel,body_rpy,foot_pos_cmd,foot_vel_cmd,foot_acc_cmd,foot_acc_numeric,foot_pos,foot_vel,foot_local_pos,foot_local_vel,jpos_cmd,jvel_cmd,jacc_cmd,jpos,jvel,vision_loc,timestamp_us
    ...
    """
    if args or kwds:
      super(wbc_test_data_lcmt, self).__init__(*args, **kwds)
      ...
      if self.body_rpy_cmd is None:
        self.body_rpy_cmd = [0.] * 3
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_3f().pack(*self.body_rpy_cmd))
      ...
      buff.write(_get_struct_3f().pack(*self.body_rpy))
      ...
      buff.write(_get_struct_16f().pack(*self.jpos_cmd))
      buff.write(_get_struct_16f().pack(*self.jvel_cmd))
      buff.write(_get_struct_16f().pack(*self.jacc_cmd))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.body_rpy_cmd = _get_struct_3f().unpack(str[start:end])
      start = end
      end += 12
      ...
      self.body_rpy = _get_struct_3f().unpack(str[start:end])
      start = end
      end += 48
      ...
      self.jpos_cmd = _get_struct_16f().unpack(str[start:end])
      start = end
      end += 64
      self.jvel_cmd = _get_struct_16f().unpack(str[start:end])
      start = end
      end += 64
      self.jacc_cmd = _get_struct_16f().unpack(str[start:end])
      start = end
      end += 64
      ...
      (self.timestamp_us,) = _get_struct_q().unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(self.body_rpy_cmd.tostring())
      ...
      buff.write(self.body_rpy.tostring())
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.body_rpy_cmd = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=3)
      start = end
      end += 12
      ...
      self.body_rpy = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=3)
      start = end
      end += 48
      ...
      self.jpos_cmd = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=16)
      start = end
      end += 64
      self.jvel_cmd = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=16)
      start = end
      end += 64
      self.jacc_cmd = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=16)
      start = end
      end += 64
