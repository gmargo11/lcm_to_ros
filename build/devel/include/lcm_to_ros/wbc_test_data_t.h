// Generated by gencpp from file lcm_to_ros/wbc_test_data_t.msg
// DO NOT EDIT!


#ifndef LCM_TO_ROS_MESSAGE_WBC_TEST_DATA_T_H
#define LCM_TO_ROS_MESSAGE_WBC_TEST_DATA_T_H
...
struct wbc_test_data_t_
{
  typedef wbc_test_data_t_<ContainerAllocator> Type;
  ...
  wbc_test_data_t_(const ContainerAllocator& _alloc)
    : contact_est()
    , Fr_des()
    , Fr()
    , body_ori_cmd()
  ...
  _foot_local_vel_type foot_local_vel;
   ...
   typedef boost::array<float, 12>  _jpos_cmd_type;
  _jpos_cmd_type jpos_cmd;

   typedef boost::array<float, 12>  _jvel_cmd_type;
  _jvel_cmd_type jvel_cmd;

   typedef boost::array<float, 12>  _jacc_cmd_type;
  _jacc_cmd_type jacc_cmd;

   typedef boost::array<float, 12>  _jpos_type;
  _jpos_type jpos;

   typedef boost::array<float, 12>  _jvel_type;
  _jvel_type jvel;
  ...
  typedef boost::shared_ptr< ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> const> ConstPtr;

}; // struct wbc_test_data_t_

typedef ::lcm_to_ros::wbc_test_data_t_<std::allocator<void> > wbc_test_data_t;

typedef boost::shared_ptr< ::lcm_to_ros::wbc_test_data_t > wbc_test_data_tPtr;
typedef boost::shared_ptr< ::lcm_to_ros::wbc_test_data_t const> wbc_test_data_tConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator1> & lhs, const ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> >
{
  ...
  static const char* value(const ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x85a0c07157642984ULL;
  static const uint64_t static_value2 = 0x91c1f628cbf01b14ULL;
};

template<class ContainerAllocator>
struct DataType< ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#######################################################################\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::lcm_to_ros::wbc_test_data_t_<ContainerAllocator>& v)
  {
...
#endif // LCM_TO_ROS_MESSAGE_WBC_TEST_DATA_T_H
