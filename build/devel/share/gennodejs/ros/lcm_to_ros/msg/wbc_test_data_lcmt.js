...
class wbc_test_data_lcmt {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('body_rpy_cmd')) {
        this.body_rpy_cmd = initObj.body_rpy_cmd
      }
      else {
        this.body_rpy_cmd = new Array(3).fill(0);
      }
      ...
      if (initObj.hasOwnProperty('body_rpy')) {
        this.body_rpy = initObj.body_rpy
      }
      else {
        this.body_rpy = new Array(3).fill(0);
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Check that the constant length array field [body_rpy_cmd] has the right length
    if (obj.body_rpy_cmd.length !== 3) {
      throw new Error('Unable to serialize array field body_rpy_cmd - length must be 3')
    }
    // Serialize message field [body_rpy_cmd]
    bufferOffset = _arraySerializer.float32(obj.body_rpy_cmd, buffer, bufferOffset, 3);
    ...
    // Check that the constant length array field [body_rpy] has the right length
    if (obj.body_rpy.length !== 3) {
      throw new Error('Unable to serialize array field body_rpy - length must be 3')
    }
    // Serialize message field [body_rpy]
    bufferOffset = _arraySerializer.float32(obj.body_rpy, buffer, bufferOffset, 3);
    ...
    if (obj.jpos_cmd.length !== 16) {
      throw new Error('Unable to serialize array field jpos_cmd - length must be 16')
    }
    // Serialize message field [jpos_cmd]
    bufferOffset = _arraySerializer.float32(obj.jpos_cmd, buffer, bufferOffset, 16);
    // Check that the constant length array field [jvel_cmd] has the right length
    if (obj.jvel_cmd.length !== 16) {
      throw new Error('Unable to serialize array field jvel_cmd - length must be 16')
    }
    // Serialize message field [jvel_cmd]
    bufferOffset = _arraySerializer.float32(obj.jvel_cmd, buffer, bufferOffset, 16);
    // Check that the constant length array field [jacc_cmd] has the right length
    if (obj.jacc_cmd.length !== 16) {
      throw new Error('Unable to serialize array field jacc_cmd - length must be 16')
    }
    // Serialize message field [jacc_cmd]
    bufferOffset = _arraySerializer.float32(obj.jacc_cmd, buffer, bufferOffset, 16);
    // Check that the constant length array field [jpos] has the right length
    if (obj.jpos.length !== 16) {
      throw new Error('Unable to serialize array field jpos - length must be 16')
    }
    // Serialize message field [jpos]
    bufferOffset = _arraySerializer.float32(obj.jpos, buffer, bufferOffset, 16);
    // Check that the constant length array field [jvel] has the right length
    if (obj.jvel.length !== 16) {
      throw new Error('Unable to serialize array field jvel - length must be 16')
    }
    // Serialize message field [jvel]
    bufferOffset = _arraySerializer.float32(obj.jvel, buffer, bufferOffset, 16);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new wbc_test_data_lcmt(null);
    ...
    // Deserialize message field [body_rpy_cmd]
    data.body_rpy_cmd = _arrayDeserializer.float32(buffer, bufferOffset, 3)
    ...
    // Deserialize message field [body_rpy]
    data.body_rpy = _arrayDeserializer.float32(buffer, bufferOffset, 3)
    ...
    data.jpos_cmd = _arrayDeserializer.float32(buffer, bufferOffset, 16)
    // Deserialize message field [jvel_cmd]
    data.jvel_cmd = _arrayDeserializer.float32(buffer, bufferOffset, 16)
    // Deserialize message field [jacc_cmd]
    data.jacc_cmd = _arrayDeserializer.float32(buffer, bufferOffset, 16)
    // Deserialize message field [jpos]
    data.jpos = _arrayDeserializer.float32(buffer, bufferOffset, 16)
    // Deserialize message field [jvel]
    data.jvel = _arrayDeserializer.float32(buffer, bufferOffset, 16)
  ...
  static Resolve(msg) {
    ...
    const resolved = new wbc_test_data_lcmt(null);
    ...
    if (msg.body_rpy_cmd !== undefined) {
      resolved.body_rpy_cmd = msg.body_rpy_cmd;
    }
    else {
      resolved.body_rpy_cmd = new Array(3).fill(0)
    }
    ...
    if (msg.body_rpy !== undefined) {
      resolved.body_rpy = msg.body_rpy;
    }
    else {
      resolved.body_rpy = new Array(3).fill(0)
    }
    ...
    if (msg.jpos_cmd !== undefined) {
      ...
      resolved.jpos_cmd = new Array(16).fill(0)
    }
    ...
    if (msg.jvel_cmd !== undefined) {
      ...
      resolved.jvel_cmd = new Array(16).fill(0)
    }
    ...
    if (msg.jacc_cmd !== undefined) {
      ...
      resolved.jacc_cmd = new Array(16).fill(0)
    }
    ...
    if (msg.jpos !== undefined) {
      ...
      resolved.jpos = new Array(16).fill(0)
    }
    ...
    if (msg.jvel !== undefined) {
      ...
      resolved.jvel = new Array(16).fill(0)
    }
...
module.exports = wbc_test_data_lcmt;
