...
if("TRUE" STREQUAL "TRUE")
  set(lcm_to_ros_SOURCE_PREFIX /catkin_ws/src/lcm_to_ros)
  set(lcm_to_ros_DEVEL_PREFIX /catkin_ws/src/lcm_to_ros/build/devel)
  ...
  set(lcm_to_ros_INSTALL_PREFIX /usr/local)
...
if(NOT "/catkin_ws/src/lcm_to_ros/build/devel/include " STREQUAL " ")
  set(lcm_to_ros_INCLUDE_DIRS "")
  set(_include_dirs "/catkin_ws/src/lcm_to_ros/build/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lcm_to_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/catkin_ws/src/lcm_to_ros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT lcm_to_ros_NUM_DUMMY_TARGETS)
      set(lcm_to_ros_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lcm_to_ros::wrapped-linker-option${lcm_to_ros_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lcm_to_ros_NUM_DUMMY_TARGETS "${lcm_to_ros_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lcm_to_ros::wrapped-linker-option${lcm_to_ros_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lcm_to_ros_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /catkin_ws/src/lcm_to_ros/build/devel/lib;/catkin_ws/devel/lib;/opt/ros/melodic/lib)
